  ...
  return (
    <div>
         <div className='absolute top-0 left-0 h-full w-full p-8 flex flex-col justify-between'>
            ...
            <div>
                <p className='text-shadow-xl text-xl leading-normal text-white mb-14'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum obcaecati voluptatum ipsum cumque quasi quisquam?</p>
